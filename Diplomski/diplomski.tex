...
Izvorni kod LTZVisora može se pronaći na stranicama GitHuba. Repozitorij sadrži sveukupno četiri direktorija: \textit{bin},
\textit{bootloader}, \textit{Documentation} i \textit{src}.
% \dirtree{%
% .1 src.
% .2 arch.
% .3 armv7.
...
\subsection{Promjene u Nesigurnom gostu}
