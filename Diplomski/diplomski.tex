...
\section{Pokretanje i konfiguracija sustava Zynq-7000 platforme}
...
\section{Prekidni sustav Zynq-7000 platforme}
...
\end{itemize}
\subsection{SGI (engl. \textit{Software Generated Interrupt})}
...
\begin{figure}[H]
  \centering
	\includegraphics[width=400pt]{AMP.png}%
...
je kreirati datoteku za pokretanje sustava BOOT.bin.
...
\begin{figure}[H]
  \centering
	\includegraphics[width=400pt]{SMP.png}%
...
\section{Utjecaj sigurnosnih ekstenzija na GIC}
\section{Konfiguriranje \textit{TrustZone} ekstenzije za AMP}
\section{Konfiguriranje \textit{TrustZone} ekstenzije za SMP}
