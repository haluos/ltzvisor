...
srušiti takve sigurnosne mehanizme govori statistika Ujedinjenog Kraljevstva koja govori da se pola od ukupnih uličnih
...
od kojih se je teško obraniti, kao što je to unošenje lozinke putem tipkovnice ili dodirnog zaslona. Ekstenzija samog procesora
...
\begin{figure}[H]
  \centering
	\includegraphics[width=250pt]{vcpu.png}%
...
u nadglednom načinu rada zadužen za zamjenu konteksta između dvije virtualne jezgre. Prijelazi iz Nesigurnog stanja u nadgledni
...
\begin{enumerate}
  ...
  \item{Sigurni mijenja procesor na kojem je aktivan, a Nesigurni koristi oba procesora}
\end{enumerate}
