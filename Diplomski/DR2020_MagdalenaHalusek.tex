...
\newacronym{fsbl}{FSBL}{FirstStage Bootloader}
...
\zahvala{
\\
Zahvaljujem se mentoru, prof. dr. sc. Mariu Cifreku, na slobodi izbora teme diplomskog rada i asistentici
...
\keywords{\textit{TrustZone}, \textit{Secure} world, \textit{Non-Secure} world, LTZVisor, \gls{amp}, \gls{smp}}
\end{abstract}
